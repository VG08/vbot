...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="connect", aliases=["join"], brief='joins the voice channel you are in. ')
    ...
    @commands.command(name="disconnect", aliases=["leave"], brief='the bot leaves the voice channel.')
    async def disconnect_command(self, ctx):
        player = self.get_player(ctx)
        await player.teardown()
        await ctx.send("Disconnected.")

    @commands.command(name="play", aliases=["resume", 'p'], brief='the bot plays the music you ask for ')
    ...
    @commands.command(name="pause", brief='pauses the music')
    ...
    @commands.command(name="next", aliases=["skip"], brief='plays the song next in queue')
    ...
    @commands.command(name="previous", brief='plays the song previous in the queue')
    ...
    @commands.command(name='shuffle', brief='shuffle')
